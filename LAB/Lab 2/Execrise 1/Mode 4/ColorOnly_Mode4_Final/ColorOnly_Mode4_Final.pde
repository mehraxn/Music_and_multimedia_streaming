...
// Mode-independent: works with Mode 1, Mode 2, Mode 3, and Mode 4.
...
void setup() {
  size(400, 400);
  oscP5 = new OscP5(this, 12000); // Wekinator sends /wek/outputs to port 12000
...
void draw() {
  if (predictedClass == 1) {
    background(255, 0, 0);   // Class 1 = red, for example voice
  } else if (predictedClass == 2) {
    background(0, 0, 255);   // Class 2 = blue, for example hand clap
  } else {
