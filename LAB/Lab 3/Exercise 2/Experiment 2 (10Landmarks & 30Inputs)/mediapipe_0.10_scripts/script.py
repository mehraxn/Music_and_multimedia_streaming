...
10-landmark experiment version

This script:
1. Opens webcam
2. Detects one hand using MediaPipe
3. Extracts 10 selected hand landmark coordinates
4. Sends them to Wekinator using OSC

For LANDMARK_MODE = 10:
10 landmarks x 3 coordinates = 30 Wekinator inputs
...
print("--------------------------------------")
print("Experiment: 10 landmarks / 30 Wekinator inputs")
...
with vision.HandLandmarker.create_from_options(options) as landmarker:
    ...
    while cap.isOpened():
        ...
        if hand_detected:
            ...
            # Extract x, y, z values for the selected 10 landmarks
            # 10 landmarks x 3 coordinates = 30 values
            ...
            # Send the 30 input features to Wekinator
            client.send_message(WEKINATOR_MESSAGE, features)

            status_text = "HAND DETECTED - SENDING 30 OSC INPUTS"
        ...
        cv2.imshow(
            "Exercise 2 - 10 Hand Landmarks to Wekinator",
            frame
        )
